...
var Student = /** @class */ (function () {
    function Student(name, studentId, school) {
        this.grades = [];
        this.name = name;
        // this.grades = grades;
        this.school = school;
    ...
    Object.defineProperty(Student.prototype, "getGrades", {
        get: function () {
            return this.grades;
        },
        set: function (grade) {
    ...
    Student.prototype.getAvgGrade = function () {
        if (this.grades.length === 0)
            return 0;
        var sum = this.grades.reduce(function (acc, val) { return acc + val; }, 0);
        return sum / this.grades.length;
    };
    return Student;
}());
var student1 = new Student("Asad Abbas", 101, "BBSUL");
